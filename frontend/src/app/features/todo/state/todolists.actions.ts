...
export const ADD_NEW_TODO_ITEM_SUCCESS =
  '[TODO LIST ITEM] add new item successfully';
export const UPDATE_TODO_ITEM = '[TODO LIST] update existing item';
export const UPDATE_TODO_ITEM_SUCCESS =
  '[TODO LIST ITEM] update existing item successfully';
export const DELETE_TODO_ITEM = '[TODO LIST ITEM] delete item';
export const DELETE_TODO_ITEM_SUCCESS =
  '[TODO LIST ITEM] delete item successfully';
